...
API.addTasksSet({
    ...
    [{ 
        ...
        type:'redirect', name:'redirecting', url: `https://uwaterloo.ca1.qualtrics.com/jfe/form/SV_0cRXcu1eJMYGY7A?respondentID=${respondentID}&Q_R=${respondentID}&redirect=1` 
    }],
